...
public class PlayerTurn {
	...
	public int getPriceOfItemName(String itemName) {
		if(itemName == "soldier0") return itemPrice[0];
		if(itemName == "soldier1") return itemPrice[1];
		if(itemName == "soldier2") return itemPrice[2];
		if(itemName == "soldier3") return itemPrice[3];
		
		if(itemName == "tower0") return itemPrice[4];
		if(itemName == "tower1") return itemPrice[5];
		
		if(itemName == "farm") return itemPrice[6];
